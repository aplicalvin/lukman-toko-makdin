...
<div class="flex flex-col min-h-screen bg-white text-slate-800" x-data="{
    ...
    <div class="m-4 p-4 bg-red-50 border border-red-200 rounded-xl flex items-start gap-3">
        ...
        <p class="text-sm text-red-700">
            Perhatian: Anda belum melakukan absen keluar untuk hari sebelumnya. Silakan lengkapi segera agar pembayaran honorarium Anda dapat berjalan lancar. Terima kasih.
        </p>
    </div>
    @endif
    ...
    <div class="mx-4 mb-4 p-5 bg-white rounded-2xl border border-slate-100 shadow-sm">
        <h3 class="text-base font-bold text-slate-800 mb-4">Absensi Hari Ini</h3>
            ...
            @if($attendance)
                <div class="flex items-center justify-between p-3 bg-slate-50 rounded-xl">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            <p class="text-sm font-semibold">Masuk</p>
                ...
                <div class="flex items-center justify-between p-3 bg-slate-50 rounded-xl">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            <p class="text-sm font-semibold">Keluar</p>
                            <p class="text-xs text-slate-400">Hari Ini</p>
                        </div>
                    </div>
                    <p class="text-sm font-bold text-slate-700">
                ...
                @endif
            @else
                <div class="text-center text-sm text-slate-400 py-4">Belum ada data absensi hari ini.</div>
            @endif
        </div>
    </div>
    ...
    <div class="mx-4 mb-20 p-5 bg-white rounded-2xl border border-slate-100 shadow-sm">
        ...
        <div class="space-y-3">
            ...
            <div class="flex justify-between items-center">
                <span class="text-sm text-slate-500">Total Gaji</span>
        ...
        <p class="text-xs text-slate-400 mt-4 text-center italic">
            "Gaji dihitung otomatis setelah absen keluar"
        </p>
    </div>
